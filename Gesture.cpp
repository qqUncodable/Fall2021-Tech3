...
/**************************************************************** 
 * Function Name: GestureSelectBank
...
uint8_t GestureInit(void) 
{
	...
	error = GestureReadReg(0, 1, &data0);
	if (error)
	{
		return error;
	}
	error = GestureReadReg(1, 1, &data1);
	if (error)
	{
		return error;
	}
	...
	GestureSelectBank(BANK0);  //gesture flage reg in Bank0
